...
public class Sql<E> implements SqlEntityInfo<E> {
	...
	*/
	...
	/**
		...
		@see org.mkokubo.lightsleep.component.Condition#of(java.lang.String, java.lang.Object...)
	*/
	...
	/**
		...
		@see org.mkokubo.lightsleep.component.Condition#of(java.lang.Object)
	*/
	...
	*/
	...
	/**
		指定のエンティティを挿入する INSERT SQL を生成して実行します。
	...
	*/
	...
	/**
		エンティティ・ストリームの各エンティティ毎に、INSERT SQL を生成して実行します。

		@param connection データベース・コネクション
		@param entityStream 挿入対象のエンティティ・ストリーム

		@return 実行結果行数

		@throws NullPointerException <b>connection</b>, <b>entityStream</b> または <b>entityStream</b> の要素が <b>null</b> の場合
		@throws RuntimeSQLException データベース・アクセス・エラーが発生した場合
	*/
	...
	/**
		エンティティ・コレクションの各エンティティ毎に、INSERT SQL を生成して実行します。

		@param connection データベース・コネクション
 		@param entities 挿入対象のエンティティ・コレクション

		@return 実行結果行数

		@throws NullPointerException <b>connection</b>, <b>entities</b> または <b>entities</b> の要素が <b>null</b> の場合
		@throws RuntimeSQLException データベース・アクセス・エラーが発生した場合
	*/
	...
	/**
		指定のエンティティで更新する UPDATE SQL を生成して実行します。
		<b>WHERE</b> 条件が指定されている場合は、その条件で更新が行われます。
		...
		@see org.mkokubo.lightsleep.component.Condition#ALL
	*/
	...
	/**
		エンティティ・ストリームの各エンティティ毎に、UPDATE SQL を生成して実行します。
		<b>WHERE</b> 条件が指定されている場合でも、各エンティティ毎に <b>new EntityCondition(entity)</b> が指定されます。

		@param connection データベース・コネクション
		@param entityStream 更新対象のエンティティ・ストリーム
	...
	*/
	...
	/**
		エンティティ・コレクションの各エンティティ毎に、UPDATE SQL を生成して実行します。
		<b>WHERE</b> 条件が指定されている場合でも、各エンティティ毎に <b>new EntityCondition(entity)</b> が指定されます。

		@param connection データベース・コネクション
		@param entities 更新対象のエンティティ・コレクション
	...
	*/
	...
	/**
		...
		<b>WHERE</b> 条件が指定されていない場合は実行されません。
	...
	*/
	...
	/**
		指定のエンティティを削除する DELETE SQL を生成して実行します。
	...
	*/
	...
	/**
		エンティティ・ストリームの各エンティティ毎に DELETE SQL を生成して実行します。

		@param connection データベース・コネクション

		@return 実行結果行数
		@param entityStream 削除対象のエンティティ・ストリーム
	...
	*/
	...
	/**
		エンティティ・コレクションの各エンティティ毎に、DELETE SQL を生成して実行します。

		@param connection データベース・コネクション
		@param entities 削除対象のエンティティ・コレクション
	...
	*/
	...
	/**
		メイン・テーブルと結合テーブルの <b>SqlEntityInfo</b> ストリームを返します。
		<i>このメソッドは、内部的に使用されます。</i>
