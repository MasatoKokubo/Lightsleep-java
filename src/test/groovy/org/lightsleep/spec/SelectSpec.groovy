...
class SelectSpec extends Base {
    ...
    // select() / forUpdate
    def "#ignore SelectSpec forUpdate #connectionSupplier"(ConnectionSupplier connectionSupplier, String ignore) {
    ...
    def "#ignore SelectSpec forUpdate noWait #connectionSupplier"(ConnectionSupplier connectionSupplier, String ignore) {
        if (!ignore.empty) return
        DebugTrace.enter() // for Debugging
    ...
    def "#ignore SelectSpec forUpdate wait N #connectionSupplier"(ConnectionSupplier connectionSupplier, String ignore) {
        if (!ignore.empty) return
        DebugTrace.enter() // for Debugging
    ...
    def "#ignore SelectSpec forUpdate - exception #connectionSupplier"(ConnectionSupplier connectionSupplier, String ignore) {
        if (!ignore.empty) return
        DebugTrace.enter() // for Debugging
    ...
    def "#ignore SelectSpec forUpdate noWait - exception #connectionSupplier"(ConnectionSupplier connectionSupplier, String ignore) {
        if (!ignore.empty) return
        DebugTrace.enter() // for Debugging
    ...
    def "#ignore SelectSpec forUpdate wait N - exception #connectionSupplier"(ConnectionSupplier connectionSupplier, String ignore) {
        if (!ignore.empty) return
        DebugTrace.enter() // for Debugging
