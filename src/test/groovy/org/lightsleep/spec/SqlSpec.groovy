...
class SqlSpec extends Specification {
    ...
    static class TestDatabase implements Database {
        ...
        @Override public <E, OE> String subSelectSql(Sql<E> sql, Sql<OE> outerSql, List<Object> parameters) {return ''}
        @Override public <E, OE> String subSelectSql(Sql<E> sql, Sql<OE> outerSql, Supplier<CharSequence> columnsSupplier, List<Object> parameters) {return ''}
    ...
    // Sql.innerJoin(Sql<JE>, String, Condition)
    // Sql.innerJoin(Sql<JE>, String, Condition, Object...)
    // Sql.leftJoin(Sql<JE>, String, Condition)
    // Sql.leftJoin(Sql<JE>, String, Condition, Object...)
    // Sql.rightJoin(Sql<JE>, String, Condition)
    // Sql.rightJoin(Sql<JE>, String, Condition, Object...)
    ...
    // 4.0.0
    // Sql.recursive(Sql<RE> recursiveSql)
