// InsertUpdateDeleteV1Spec.groovy
...
// InsertUpdateDeleteV1Spec
@Unroll
class InsertUpdateDeleteV1Spec extends SpecCommon {
	def setup() {
		deleteAllTables()
	}
	 ...
	 * Normal case
	*/
	def "InsertUpdateDeleteV1Spec insert update delete - 1 row - #connectionSupplier"(
	 ...
	 * Normal case
	 */
	def "InsertUpdateDeleteV1Spec insert update delete - multiple rows - #connectionSupplier"(
		ConnectionSupplier connectionSupplier) {
	/**/DebugTrace.enter()
	/**/DebugTrace.print('connectionSupplier', connectionSupplier)
		setup:
	 ...
	 * Normal case
	 */
	def "InsertUpdateDeleteV1Spec update delete - with condition - #connectionSupplier"(
		ConnectionSupplier connectionSupplier) {
	 ...
	 *  Error case / Illegal argument
	 */
	def "InsertUpdateDeleteV1Spec insert update delete - exception"() {
	/**/DebugTrace.enter()
		// insert
		when:
			Transaction.execute(connectionSupplier) {
	...
	def "InsertUpdateDeleteV1Spec optimistic lock #connectionSupplier" (
		ConnectionSupplier connectionSupplier) {
	/**/DebugTrace.enter()
	/**/DebugTrace.print('connectionSupplier', connectionSupplier)
